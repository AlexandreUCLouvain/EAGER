...
const JackknifeTemplate = require('./jackknife_template').JackknifeTemplate;
const JackknifeFeatures = require('./jackknife_features').JackknifeFeatures;
const Distributions = require('./jackknife_train').Distributions;
const compareTemplates = require('./jackknife_template').compareTemplates;
const gpsr = require('./mathematics').gpsr;
